...
public class InputManager : MonoBehaviour
{
    ...
    [SerializeField] private InputAsset inputAsset = null;
    ...
    public void Start()
    {
        ...
        inputAsset.Player.DragLeft.performed +=
            ctx =>
            {
                ...
                LeftDragVectorEvent?.Invoke( Camera.main.ScreenToWorldPoint(ctx.ReadValue<Vector2>()) - Camera.main.ScreenToWorldPoint(DragLeftStartScreenPos));
                Debug.Log("Drag");
