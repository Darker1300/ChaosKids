...
namespace AnimationLibrary
{
    ...
    public class LerpWithinFactor 
    {
        ...
        public float GetZeroToOneLerpValueFromMainLerpValue( float PassedInputValue)
        {
            ...
            else OutOfCurrentSpotFindAsignCurrentIndex( PassedInputValue);
            return OutputValue;
        }

        public bool OutOfCurrentSpotFindAsignCurrentIndex( float PassedInputValue)
        {
        ...
        public void ConfigureIndex(float InputValue)
        {
            OutOfCurrentSpotFindAsignCurrentIndex(InputValue);
        }
